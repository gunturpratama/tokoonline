...
<html> 
   <head> 
      <?php
         $page  = "pengiriman";
         $title = "Daftar Pengiriman | Gagapan Bali";
         require_once "controller/c_if_ada_session_atau_cookie.php";
         require_once "controller/c_pengiriman.php";
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>Pengiriman<small>Control panel</small></h1>
               <ol class="breadcrumb">
            ...
            <section class="content">
               <?php
                  ...
                  require_once "view/v_pengiriman.php";
                ?>
            </section>
            <!--end maincontent-->
         </div>
